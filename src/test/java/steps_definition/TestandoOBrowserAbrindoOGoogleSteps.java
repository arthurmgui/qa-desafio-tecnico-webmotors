...
public class TestandoOBrowserAbrindoOGoogleSteps extends BaseSteps {
    ...
    @Quando("^abro o Google$")
    public void abro_o_Google() throws Throwable {
    }

    @Entao("^ele me mostra a imagem do Google$")
    public void ele_me_mostra_a_imagem_do_Google() throws Throwable {
    }
}
